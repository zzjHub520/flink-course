package com.atguigu.chapter09_StateProgramming;
                ...
                .process(new CoProcessFunction<Tuple3<String, String, Long>, Tuple3<String, String, Long>, String>() {
                    ...
                    public void open(Configuration parameters) throws Exception {
                        ...
                        stream1ListState = getRuntimeContext().getListState(
                                new ListStateDescriptor<Tuple2<String, Long>>("stream1-list", Types.TUPLE(Types.STRING, Types.STRING))
                        );
                        stream2ListState = getRuntimeContext().getListState(
                                new ListStateDescriptor<Tuple2<String, Long>>("stream2-list", Types.TUPLE(Types.STRING, Types.STRING))
                        );
                    }
                    ...
                    public void processElement1(Tuple3<String, String, Long> left, Context context, Collector<String> collector) throws Exception {
                        ...
                        for (Tuple2<String, Long> right : stream2ListState.get()) {
                            collector.collect("stream1: " + left + " => " + right);
                        }
                    }
                    ...
                    public void processElement2(Tuple3<String, String, Long> right, Context context, Collector<String> collector) throws Exception {
                        ...
                        for (Tuple2<String, Long> left : stream1ListState.get()) {
                            collector.collect("stream2: " + left + " => " + right);
                        }
                    }
                })
                .print();
